...
struct SLACKOPENAPI_API HttpRetryManager
	: public FManager
...
struct SLACKOPENAPI_API HttpRetryParams
{
	HttpRetryParams(
...
class SLACKOPENAPI_API Request
{
public:
	virtual ~Request() {}
...
class SLACKOPENAPI_API Response
{
public:
	virtual ~Response() {}
	virtual bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) = 0;
